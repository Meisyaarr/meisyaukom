        ...
        <section id="content">
            ...
            <article>
                <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2 text-center">
                    <img src="{{ asset('img/8685b3cf794b74f8d541c1eb4ae5bba7.jpg') }}" class="rounded-circle" width="80px" height="80" alt="">
                    ...
                    <p class="text-muted text-center" style="margin-top: -15px;">stevejobs@gmail.com
                        <button type="button" class="btn btn-secondary btn-sm btn-block" disabled>Invite Member</button>
                    </p>
                        ...
                        <p class="font-weight-bold text-center px-4" style="margin-top: 15px;">+62 XXXXXXXX</p>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="font-weight-bold">Data Suplier</h5>
                        @csrf
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-outline-primary btn-sm">Cari Laporan</button>
                                <a href=""class="btn btn-outline-secondary btn-sm">Tambah Stock</a>
                            </div>
                        </form>
                    <div>
